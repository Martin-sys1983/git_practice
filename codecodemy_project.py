...
def get_traveler_location(traveler):
  ...
  travel_destination_index =        get_destination_index(travel_destination)
  return travel_destination_index

test_destination_index = get_traveler_location(test_traveler)
print(test_destination_index)
#Visiting intresting places
...
def add_attraction(destination, attraction):
  try:
    ...
    atraction_for_destination = attractions[destination_index].append(attraction)
  except ValueError:
    return
